...
def rnn_step_forward(x, prev_h, Wx, Wh, b):
    ...
    # The hidden state is computed as tanh(x * Wx + prev_h * Wh + b)
...
def rnn_forward(x, h0, Wx, Wh, b):
    ...
    # Initialize the output tensor for all hidden states
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    # Compute activations for all gates simultaneously
    a = x @ Wx + prev_h @ Wh + b
    
    # Extract the individual gates (assuming order: i, f, o, g)
