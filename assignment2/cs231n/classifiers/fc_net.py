...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # Forward pass for hidden layers: {affine - [norm] - relu - [dropout]}
        for i in range(1, self.num_layers):
            ...
            if self.use_dropout:
                ...
                dropout_caches[i] = dp_cache
                
            # Bundle cache for this layer block
            caches[i] = (fc_cache, norm_cache, relu_cache)
            
        # Forward pass for final output layer: affine only
        ...
        dout, dW, db = affine_backward(dscores, caches[L])
